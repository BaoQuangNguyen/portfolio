    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center gap-4">
        <Card 
          ...
          description="We'll collaborate to map out our projects goals, target audience, and key functionalities. We'll discuss things like project structure, navigation, and content requirements.">
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
          ...
          description="Once we agree on the plan, I cue my music playlist and dive into coding. From initial sketches to polished code, I keep you updated every step of the way.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
          ...
          description="This is where the magic happens! Based on the approved design, I'll translate everything into functional code, building our project from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
